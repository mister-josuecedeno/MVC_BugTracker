...
namespace MVC_BugTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,UserId,Property,OldValue,NewValue,Description,Created")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,UserId,Property,OldValue,NewValue,Description,Created")] TicketHistory ticketHistory)
        {
