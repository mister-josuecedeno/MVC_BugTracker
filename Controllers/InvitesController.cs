...
namespace MVC_BugTracker.Controllers
{
    public class InvitesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CompanyId,ProjectId,InviteeId,InvitorId,InviteDate,CompanyToken,InviteeEmail,FirstName,LastName,isValid")] Invite invite)
        {
